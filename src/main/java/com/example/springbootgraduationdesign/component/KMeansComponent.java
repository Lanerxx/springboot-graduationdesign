...
//        }
    ...
    public EnumWarehouse.SUCCESS_DEGREE getDegree(int i, int n){
        if (i*1.0/n <= 1.0/3) return EnumWarehouse.SUCCESS_DEGREE.低;
        else if (i*1.0/n <= 2.0/3) return EnumWarehouse.SUCCESS_DEGREE.中;
        return EnumWarehouse.SUCCESS_DEGREE.高;
    }
